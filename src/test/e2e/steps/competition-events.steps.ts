...
defineStep(/^I navigate to a "Soccer" competition page$/, () => {
 ...
 console.log($(`/html/body/div[1]/div/div[4]/div[2]/div/ul/li[1]/a`).getText());
...
defineStep(/^I select a competition event in-play$/, () => {
  ...
  $(`/html/body/div[1]/div/div[4]/div[2]/div[3]/div[1]/details/div/ol/li[1]/div/a/div[1]/span[2]`).click(); 
});
defineStep(/^I can see the "Match Odds" default market$/, () => {
 $(`/html/body/div[1]/div/div[4]/div[2]/div[2]/div[3]/details/summary/div/div`).getText();  
});
